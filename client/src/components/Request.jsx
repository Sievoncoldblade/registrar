    ...
    <>
      <div className='w-full h-full'>
        ...
        <div className='flex justify-around mx-4 h-full gap-2'>
          <div className='flex flex-col w-1/4 h-screen justify-between border border-gray-300'>
            <div>
              <div>
                <p className='bg-gray-200 px-4 py-2 font-semibold border-b border-gray-300'>
                  PUP Data Privacy Notice
                </p>
              </div>
              <div className='px-4 py-2'>
                <p className='text-xs'>
                  PUP respects and values your rights as a data subject under
                  the Data Privacy Act (DPA). PUP is committed to protecting the
                  personal data you provide in a accordance with the
                  requirements under the DPA and its IRR. In this regard, PUP
                  implements reasonable and appropriate security measures to
                  maintain the confidentiality, integrity and availabilty of
                  your personal data. For more detailed Privacy Statement, you
                  may visit{" "}
          ...
          <div className='flex flex-col w-3/4 border border-gray-300 h-full'>
            <p className='bg-gray-200 py-2 px-4 font-semibold border-b border-gray-300'>
              Request Form
            </p>
            <div className='flex flex-col gap-4 px-4 py-2'>
              <form onSubmit={handleFormSubmit}>
                <p className='text-sm'>
                  Fields highlighted in <span className='text-red-600'>*</span>{" "}
                  are required
                </p>
                  ...
                  <div className='flex gap-8'>
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <input
                        ...
                        id='extension_name'
                        placeholder={
                          extension_name !== undefined ? extension_name : ""
                        }
                ...
                <div className='flex flex-row gap-8'>
                  ...
                  <div className='bg-green-200 p-4 text-green-700 flex flex-col gap-2'>
                    ...
                    <p className='text-sm'>
                      Your appointment request will be forwared to the concerned
                      office after you click the &quot;Submit&quot; button
                    </p>
                    <p className='text-sm'>
                      Confirmation (approved/disapproved) of the request will be
                      sent to your registered email.
                    </p>
                    <p className='text-sm'>
                      You may also constantly monitor the status of the request
                      by going to{" "}
                ...
                <div className='flex my-2 gap-4'>
                  ...
                  <button
                    type='submit'
                    className='w-32 bg-red-800 text-white rounded-md px-4 py-2'
                  >
                    Submit
                  </button>
                </div>
